...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data">
	<?php wp_nonce_field( 'gonecontrol_import_entries' ); ?>
	<input type="hidden" name="action" value="<?php echo esc_attr( $args['action'] ?? '' ); ?>">
	<input type="hidden" name="gonecontrol_import_type" value="csv">
	<input type="file" name="gonecontrol_import_file" accept=".csv,text/csv">
...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data">
	<?php wp_nonce_field( 'gonecontrol_import_entries' ); ?>
	<input type="hidden" name="action" value="<?php echo esc_attr( $args['action'] ?? '' ); ?>">
	<input type="hidden" name="gonecontrol_import_type" value="text">
	<input type="file" name="gonecontrol_import_file" accept=".txt,text/plain">
